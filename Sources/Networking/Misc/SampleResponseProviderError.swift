//
//  SampleResponseProviderError.swift
//  
//
...
/// An error that occurs during loading a ``Response`` from assets by `SampleResponseProvider`.
enum SampleResponseProviderError: Error {
